...
describe('requires regex', function () {
  ...
  it('should match in variables', function () {
    var m = '    var path = require(\'path\');\n\nvar list = require(\'dirs\');'.match(re());
    m.should.eql([ 'var path = require(\'path\')', 'var list = require(\'dirs\')' ]);
  });

  it('should match in methods', function () {
    var m = 'module.exports = require(\'export-files\')(__dirname);'.match(re());
    m.should.eql([ 'require(\'export-files\')' ]);
  });
});